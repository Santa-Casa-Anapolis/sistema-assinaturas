          ...
          <div className="border-2 border-dashed border-gray-300 rounded-lg p-4 text-center">
            <div className="mb-4">
              ...
              {signaturePositions[currentPage] && (
                <div className="inline-flex items-center px-4 py-2 bg-green-500 text-white rounded-lg text-sm font-medium shadow-lg">
              ...
              >
                ...
                {signaturePositions[page] && (
                  <div className="flex items-center justify-center mt-1">
                    <span className="w-2 h-2 bg-green-500 rounded-sm mr-1"></span>
                    <span className="text-xs">Assinatura marcada</span>
                  </div>
                )}
              </div>
            ))}
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-8">
              ...
              <div className={`flex items-center space-x-2 ${currentStep >= 3 ? 'text-blue-600' : 'text-gray-400'}`}>
                ...
                {currentStep === 3 && signaturePositions[currentPage] && (
                  <div className="ml-2 inline-flex items-center px-2 py-1 bg-green-500 text-white rounded text-xs font-medium">
